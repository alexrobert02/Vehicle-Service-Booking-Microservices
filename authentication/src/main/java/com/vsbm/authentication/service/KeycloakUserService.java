package com.vsbm.authentication.service;
...
public class KeycloakUserService {
    ...
    public Map login(LoginRequest request) {
        String tokenUri = "http://localhost:8080/realms/vsbm/protocol/openid-connect/token";
    ...
    public void registerUser(RegisterRequest request) {
        ...
        webClient.post()
                .uri("http://localhost:8080/admin/realms/vsbm/users")
        ...
        Map roleRepresentation = webClient.get()
                .uri("http://localhost:8080/admin/realms/vsbm/roles/{roleName}", request.getRole().name().toLowerCase())
                .header("Authorization", "Bearer " + token)
                .retrieve()
                .bodyToMono(Map.class)
                .block();
        ...
        webClient.post()
                .uri("http://localhost:8080/admin/realms/vsbm/users/{userId}/role-mappings/realm", userId)
                .header("Authorization", "Bearer " + token)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public List<Map> getUsersByRole(String role) {
        ...
        return webClient.get()
                .uri("http://localhost:8080/admin/realms/vsbm/roles/{role}/users", role.toLowerCase())
                .header("Authorization", "Bearer " + token)
                .retrieve()
                .bodyToFlux(Map.class)
                .collectList()
